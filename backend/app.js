...
app.get("/getEnv", function (req, res) {
  try {
    ...
    if (environment == "SANDBOX") {
      ...
      config.MYINFO_CONNECTOR_CONFIG.TOKEN_URL =
        config.APP_CONFIG.MYINFO_API_TOKEN[environment];
      config.MYINFO_CONNECTOR_CONFIG.PERSON_URL =
        config.APP_CONFIG.MYINFO_API_PERSON[environment];
      console.log(
